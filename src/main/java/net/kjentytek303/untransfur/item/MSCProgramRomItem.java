...
public class MSCProgramRomItem extends Item {
	...
	public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
		...
		if(program != null && program.contains("program")) {
			pTooltipComponents.add(Component.translatable("item.untransfur.msc_program_rom.tooltip", Component.translatable( "untransfur.msc.program." + program.getString("program"))));
		} else {
